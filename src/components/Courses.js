      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4">
            <img src="https://via.placeholder.com/400x300" alt="Basic Computer Skills" className="img-fluid" />
          ...
          <div className="col-md-4">
            <img src="https://via.placeholder.com/400x300" alt="English Typing" className="img-fluid" />
            <h3>English Typing</h3>
            <p>Improve your typing speed and accuracy in English with our comprehensive typing courses.</p>
          </div>
          <div className="col-md-4">
            <img src="https://via.placeholder.com/400x300" alt="Hindi Typing" className="img-fluid" />
            <h3>Hindi Typing</h3>
            <p>Enhance your typing skills in the Hindi language, with courses designed for beginners and advanced learners alike.</p>
          </div>
          <div className="col-md-4">
            <img src="https://via.placeholder.com/400x300" alt="Shorthand Stenography" className="img-fluid" />
